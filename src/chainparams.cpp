...
public:
	...
	consensus.BIP34Height = 710000;
        //consensus.BIP34Hash = uint256S("fa09d204a83a768ed5a7c8d441fa62f2043abf420cff1226c7b4329aeb9d51cf");
        consensus.BIP65Height = 710000; // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        consensus.BIP66Height = 710000; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); 
        consensus.nPowTargetTimespan = 1.0 * 60 * 60; // 1 hour 
        consensus.nPowTargetSpacing = 2 * 60;
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1916; // 95% of 2016
        consensus.nMinerConfirmationWindow = 30; // nPowTargetTimespan / nPowTargetSpacing * 4
	...
	genesis = CreateGenesisBlock(1413817324, 1591189, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x30758383eae55ae5c7752b73388c1c85bdfbe930ad25ad877252841ed1e734a4"));
        ...
        vSeeds.emplace_back("dnsseed.vtscc.org");
        vSeeds.emplace_back("dnsseed.woodcoin.info");
        ...
        checkpointData = {
            {
                {  1, uint256S("0xcf6d38058e646c6de8f9cc0ae9d5f345e5da4e666f12f982e35ff1e2352e57c3")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        //consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1517356801; // January 31st, 2018
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 9483228800; // January 1, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 9517356801; // January 31st, 2018
